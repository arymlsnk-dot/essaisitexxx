...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-[#ffffff] relative overflow-x-hidden w-full" style={{ backgroundColor: "transparent" }}>
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 md:px-12 py-6 bg-gradient-to-b from-black/80 to-transparent">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/40 backdrop-blur-md px-4 py-2 border border-white/10 rounded-sm w-[240px] md:w-[320px]">
          ...
          <input
            ...
            className="bg-transparent border-none outline-none text-xs tracking-widest w-full placeholder:text-white text-white focus:ring-0 uppercase font-sans"
            style={{ color: "#ffffff" }}
          />
        </div>
